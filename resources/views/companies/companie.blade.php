...
@section('title','SmartSol | Entreprises')
...
<div class="min-h-screen px-6 md:px-8 py-10">
    ...
    <div class="max-w-5xl mx-auto text-center mb-10">
        ...
        <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#FBB108]/10 border border-[#FBB108]/20 text-[#FBB108] text-sm mb-5">
            ...
            Réseau National des Entreprises Solaires
        </div>

        <h1 class="text-4xl md:text-5xl font-black text-white leading-tight">
            Annuaire des
            <span class="text-[#FBB108]">Entreprises Solaires</span>
        </h1>

        <p class="text-gray-400 mt-4 max-w-2xl mx-auto">
            Trouvez rapidement des sociétés spécialisées dans les panneaux solaires,
            l’énergie photovoltaïque et les solutions énergétiques partout au Maroc.
        </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
                ...
                <select
                    ...
                    <option value="Rabat">Rabat / Témara</option>
    ...
    <!-- LIST -->
    <div id="companiesList" class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
...
<script>
    function filterCompanies() {
        ...
        const cards =
            document.getElementsByClassName('company-card');
